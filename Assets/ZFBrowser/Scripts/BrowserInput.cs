...
internal class BrowserInput {
	...
	private void HandleKeyInput() {
            ...
            lock (browser.UIHandler.KeyEvents)
            {
                keyEvents = browser.UIHandler.KeyEvents;
...
#endif
                //Debug.Log(keyEvents.Count);
                foreach (var ev in keyEvents)
                {
                    //Debug.Log( "Character: " + (int)ev.character);
                    ...
                    //}
                    // Debug.Log("BrowserInput: " + keyCode);
#if ZF_OSX
			FireCommands(ev);
#endif
