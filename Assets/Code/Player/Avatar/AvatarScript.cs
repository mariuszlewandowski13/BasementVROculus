...
public class AvatarScript : MonoBehaviour {
    ...
    public void SetAvatarName(string name)
    {
        ...
        transform.Find("avatarName").GetComponent<TextMesh>().text = name;
    }
    ...
    {
        SetAvatarName(name);
        gameObject.transform.Find("avatarName").GetComponent<FFollowScript>().ObjectToLookAt = GameObject.Find("CenterEyeAnchor");
        gameObject.transform.Find("avatarName").GetComponent<FFollowScript>().LookAtRot = true;
      // gameObject.transform.FindChild("avatarName").GetComponent<CubeLerp>().serializeRotation = false;
    }
