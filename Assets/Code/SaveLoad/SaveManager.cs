...
public static class SaveManager {
    ...
    public static void SaveGameObject(GameObject gameObject)
    {
        if (!TutorialScript.tutorialActive)
        {
            ...
            else if (gameObject.GetComponent<VideoScript>() != null)
            {
                SaveVideoObject(gameObject);
            }
            else if (gameObject.GetComponent<BrowserScript>() != null)
            {
                SaveBrowserObject(gameObject);
            }
    ...
    {
        //zapisywanie rodzaju obiektu
        //writeObject.WriteLine("ImageObject");
        //zapisywanie w obiekcie aktualnego komponentu transform
    ...
    {
        //zapisywanie rodzaju obiektu
       // writeObject.WriteLine("ShapeObject");
        //zapisywanie w obiekcie aktualnego komponentu transform
    ...
    {
        //zapisywanie rodzaju obiektu
       // writeObject.WriteLine("Shape3DObject");
        //zapisywanie w obiekcie aktualnego komponentu transform
        ...
        //string jsonString = JsonUtility.ToJson(gameObject.GetComponent<Shape3DScript>().shapeObject);
        // writeObject.WriteLine(jsonString);
    }
    ...
    {
        //zapisywanie rodzaju obiektu
     //   writeObject.WriteLine("SeparatorObject");
        //zapisywanie w obiekcie aktualnego komponentu transform
        ...
        // string jsonString = JsonUtility.ToJson(gameObject.GetComponent<SeparatorScript>().separatorObject);
        //  writeObject.WriteLine(jsonString);
    }
    ...
    {
        //zapisywanie rodzaju obiektu
      //  writeObject.WriteLine("TextObject");
        //zapisywanie w obiekcie aktualnego komponentu transform
        ...
        // string jsonString = JsonUtility.ToJson(gameObject.GetComponent<TextScript>().textObject);
        //  writeObject.WriteLine(jsonString);
    }
    ...
    {
        //zapisywanie rodzaju obiektu
       // writeObject.WriteLine("LineObject");
        //zapisywanie w obiekcie aktualnego komponentu transform
    ...
    private static void SaveVideoObject(GameObject gameObject)
    {
        //zapisywanie rodzaju obiektu
        //writeObject.WriteLine("ImageObject");
        //zapisywanie w obiekcie aktualnego komponentu transform
        gameObject.GetComponent<VideoScript>().videoObject.SaveActualTransformation(gameObject.transform);
        gameObject.GetComponent<VideoScript>().videoObject.PhotonViewID = gameObject.GetComponent<PhotonView>().viewID;

        if (!gameObject.GetComponent<VideoScript>().videoObject.saved)
        {
            string sql = gameObject.GetComponent<VideoScript>().videoObject.CreatSQLFromProperties();
            masterObj.GetComponent<ServerSaveLoadScript>().InsertIntoDatabase(ApplicationStaticData.roomToConnectName, sql);
            gameObject.GetComponent<VideoScript>().videoObject.saved = true;
        }
        else {
            string sql = gameObject.GetComponent<VideoScript>().videoObject.UpdateSQLProperties();
            masterObj.GetComponent<ServerSaveLoadScript>().UpdateInDatabase(ApplicationStaticData.roomToConnectName, sql, gameObject.GetComponent<VideoScript>().videoObject.PhotonViewID);
        }
    }

    private static void SaveBrowserObject(GameObject gameObject)
    {
        //zapisywanie rodzaju obiektu
        //zapisywanie w obiekcie aktualnego komponentu transform
        gameObject.GetComponent<BrowserScript>().browserObject.SaveActualTransformation(gameObject.transform);
        gameObject.GetComponent<BrowserScript>().browserObject.PhotonViewID = gameObject.GetComponent<PhotonView>().viewID;

        if (!gameObject.GetComponent<BrowserScript>().browserObject.saved)
        {
            string sql = gameObject.GetComponent<BrowserScript>().browserObject.CreatSQLFromProperties();
            masterObj.GetComponent<ServerSaveLoadScript>().InsertIntoDatabase(ApplicationStaticData.roomToConnectName, sql);
            gameObject.GetComponent<BrowserScript>().browserObject.saved = true;
        }
        else {
            string sql = gameObject.GetComponent<BrowserScript>().browserObject.UpdateSQLProperties();
            masterObj.GetComponent<ServerSaveLoadScript>().UpdateInDatabase(ApplicationStaticData.roomToConnectName, sql, gameObject.GetComponent<BrowserScript>().browserObject.PhotonViewID);
        }
    }
