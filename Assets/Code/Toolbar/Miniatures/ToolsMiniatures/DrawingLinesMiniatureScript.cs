...
public class DrawingLinesMiniatureScript : MonoBehaviour {
    ...
    private void LoadDrawer()
    {
        ...
        Material mat = GameObject.Find("Player").transform.Find("Toolbar").Find("paski").GetComponent<LinesTexturesScript>().linesMaterials[((LineDrawingObject)drawer).textureNumber];
        Texture tex = GameObject.Find("Player").transform.Find("Toolbar").Find("paski").GetComponent<LinesTexturesScript>().lines[((LineDrawingObject)drawer).textureNumber];
        ...
        UpdateColor(color);
        isSet = true;
        GameObject.Find("Player").transform.Find("Toolbar").Find("paski").Find("panel_color").GetComponent<ToolbarMainColorPickerScript>().colorChange += UpdateColor;
    }
    ...
    {
        return GameObject.Find("Player").transform.Find("Toolbar").Find("paski").Find("panel_color").GetComponent<ToolbarMainColorPickerScript>().color;
    }
