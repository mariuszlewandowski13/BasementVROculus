...
public class LineScript : MonoBehaviour {
    ...
    public void LoadFromLineObject()
    {
        if (lineObject != null)
        {
            Texture tex = GameObject.Find("Player").transform.Find("Toolbar").Find("paski").GetComponent<LinesTexturesScript>().lines[lineObject.textureNumber];
            Material mat = GameObject.Find("Player").transform.Find("Toolbar").Find("paski").GetComponent<LinesTexturesScript>().linesMaterials[lineObject.textureNumber];
            ...
            GetComponent<LineRenderer>().positionCount =  lineObject.points.Length;
