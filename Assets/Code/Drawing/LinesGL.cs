...
public class LinesGL : MonoBehaviour {
    ...
    {
        parentController.transform.parent.Find("DrawingMarker").GetComponent<TrailRenderer>().enabled = false;
        ...
        if ((myLineObject.straight == true && line == null) || (myLineObject.straight == false))
        {
            ...
            {
                TutorialScript.lines.Add(line);
            }

            //rysowanie u innych u�ytkownik�w
    ...
    private void AddPoint(GameObject controller)
    {
        ...
        Vector3 newPointPosition = controller.transform.parent.Find("DrawingMarker").position;
    ...
    private void triggerUp(GameObject controller)
    {
        ...
        controller.transform.parent.GetComponent<ControllerTouchpadScript>().TouchpadSwipeOnControllerAction -= ChangeLineTickness;
        drawing = false;
        parentController.transform.parent.Find("DrawingMarker").GetComponent<TrailRenderer>().enabled = true;
    ...
    private void UpdateLine(List<Vector3> lin = null)
    {
        ...
        line.GetComponent<LineRenderer>().positionCount = lin.Count;
    ...
    {
        Vector3 e = controller.transform.parent.Find("DrawingMarker").position;
    ...
    public void SetDrawLinesOn(GameObject control, LineDrawingObject line)
    {
        ...
        control.GetComponent<Renderer>().enabled = false;
        control.transform.parent.Find("DrawingMarker").gameObject.SetActive(true);

        control.GetComponent<ControlObjects>().TriggerDown += triggerDown;

        GameObject.Find("Player").transform.Find("Toolbar").Find("paski").Find("panel_color").GetComponent<ToolbarMainColorPickerScript>().colorChange += SetLineColor;
        control.transform.parent.Find("DrawingMarker").GetComponent<TrailRenderer>().enabled = true;
    ...
    public void SetDrawLinesOff(GameObject control)
    {
        ...
        parentController.transform.parent.Find("DrawingMarker").gameObject.GetComponent<TrailRenderer>().enabled = false;
    ...
    {
        parentController.transform.parent.Find("DrawingMarker").GetComponent<Renderer>().material.color = lineColor;

    }

    void OnDestroy()
    {
        parentController.GetComponent<Renderer>().enabled = true;
        parentController.transform.parent.Find("DrawingMarker").gameObject.SetActive(false);
    }
    ...
    private void SetMarkerTrailColor()
    {
        ...
        color.a = 1.0f;
        parentController.transform.parent.Find("DrawingMarker").GetComponent<TrailRenderer>().material.SetColor("_TintColor", color);
    }
