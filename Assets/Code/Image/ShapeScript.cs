...
public class ShapeScript : MonoBehaviour, IResizable {
    ...
    void Start()
    {
        ...
        if(gameObject.transform.Find("Plane") != null) gameObject.transform.Find("Plane").GetComponent<Renderer>().sortingLayerName = "PhysicalObjectsSortingLayer";
    }
    ...
    private void LoadMaterialToRenderer()
    {
        ...
        {
            transform.Find("Plane").GetComponent<Renderer>().material.mainTexture = newMaterial;
        }
    ...
    private void SetColorToRenderer()
    {
        if (transform.Find("Plane") != null)
        {
            transform.Find("Plane").GetComponent<Renderer>().material.SetColor("_Color", shapeObject.color);
        }
