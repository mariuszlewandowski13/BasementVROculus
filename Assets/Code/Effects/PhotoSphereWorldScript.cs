...
public class PhotoSphereWorldScript : MonoBehaviour {
    ...
    private void ControllerCollision(GameObject gameObj, bool isEnter)
    {
        if (!wearing)
        {
            ...
            (gameObject.transform.Find("ScaleHandler") == null && gameObj.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.Find("ScaleHandler") == null) ||
            (gameObj.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.Find("ScaleHandler") == null && gameObject.transform.Find("ScaleHandler") != null && !gameObj.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.IsChildOf(gameObject.transform.Find("ScaleHandler"))) ||
            (gameObj.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.Find("ScaleHandler") != null && gameObject.transform.Find("ScaleHandler") == null && !transform.IsChildOf(gameObj.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.Find("ScaleHandler"))) ||
            (gameObject.transform.Find("ScaleHandler") != null && gameObj.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.Find("ScaleHandler") != null)
            ) && canMove)
                { 
    ...
    private void OnTriggerDown(GameObject controller)
    {
        ...
        if ((controller.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup == null ||
           (gameObject.transform.Find("ScaleHandler") == null && controller.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.Find("ScaleHandler") == null) ||
           (controller.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.Find("ScaleHandler") == null && gameObject.transform.Find("ScaleHandler") != null && !controller.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.IsChildOf(gameObject.transform.Find("ScaleHandler"))) ||
           (controller.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.Find("ScaleHandler") != null && gameObject.transform.Find("ScaleHandler") == null && !transform.IsChildOf(controller.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.Find("ScaleHandler"))) ||
           (gameObject.transform.Find("ScaleHandler") != null && controller.GetComponent<ControlObjects>().secondController.GetComponent<ControlObjects>().pickup.transform.Find("ScaleHandler") != null)
           ) && canMove)
        {
            if (GetComponent<PhotonView>() != null)
    ...
    private void WearSphere(GameObject controller)
    {
        ...
        GameObject.Find("CenterEyeAnchor").GetComponent<Camera>().cullingMask = (1 << LayerMask.NameToLayer("NewWorld")) | (1 << LayerMask.NameToLayer("Controllers"));
        ControlObjects.TriggerDownGlobal += UnWearSphere;
        GameObject.Find("CenterEyeAnchor").GetComponent<TeleportVive>().enabled = false;
    ...
    private void UnWearSphere(GameObject controller)
    {
        ...
        GameObject.Find("CenterEyeAnchor").GetComponent<Camera>().cullingMask = -1 ;
        GameObject.Find("CenterEyeAnchor").GetComponent<Camera>().cullingMask &= ~(1 << LayerMask.NameToLayer("MyAvatar"));


        ControlObjects.TriggerDownGlobal -= UnWearSphere;
        GameObject.Find("CenterEyeAnchor").GetComponent<TeleportVive>().enabled = true;
        if (GetComponent<DuplicateObjectScript>() != null)
        {
