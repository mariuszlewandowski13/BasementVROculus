...
public class TextColorScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (objectToChangeColor.transform.Find("ScaleHandlerPlane").Find("ScaleHandler") != null)
            {
                if (objectToChangeColor.transform.Find("ScaleHandlerPlane").Find("ScaleHandler").Find("Top") != null)
                {
                    if (objectToChangeColor.transform.Find("ScaleHandlerPlane").Find("ScaleHandler").Find("Top").GetComponent<Renderer>() != null)
                    {
                        float alpha = objectToChangeColor.transform.Find("ScaleHandlerPlane").Find("ScaleHandler").Find("Top").GetComponent<Renderer>().material.color.a;
