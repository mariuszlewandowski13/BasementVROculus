	...
	public class ArcTeleporterEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			case ArcTeleporter.FiringMode.ARC:
				...
				{
					SerializedProperty goodTeleShader = serializedTeleporter.FindProperty("goodTeleShader");
					SerializedProperty badTeleShader = serializedTeleporter.FindProperty("badTeleShader");
					if (goodTeleShader.objectReferenceValue == null && badTeleShader.objectReferenceValue == null && oldArcMatInt != arcMat.intValue)
					{
			...
			SerializedProperty onMoveSound = serializedTeleporter.FindProperty("onMoveSound");
